...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i in range(len(low_letters)):
            lowletter = low_letters[i]
            uppletter = upp_letters[i]
            if i + shift > 25:
                plusindex = shift - (25 - i)
                mydict[lowletter] = low_letters[plusindex - 1]
                mydict[uppletter] = upp_letters[plusindex - 1]
            else:
                mydict[lowletter] = low_letters[i + shift]
                mydict[uppletter] = upp_letters[i + shift]
        return mydict
